...
diabetes_model = pickle.load(open(r"C:\Users\trupt\diabetes_model.sav",'rb'))

heart_disease_model = pickle.load(open(r"C:\Users\trupt\heart_disease_model.sav",'rb'))

parkinsons_model = pickle.load(open(r"C:\Users\trupt\parkinsons_model.sav",'rb'))
